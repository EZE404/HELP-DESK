CREATE EVENT 'historials_hours' ON SCHEDULE EVERY 1 MINUTE STARTS '2021-08-02 02:43:28.000' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
...
VALUES(ids, fecha_cur, CONCAT('36HS EVENT: ', msg));
END IF;
END LOOP;
CLOSE resultado;
END